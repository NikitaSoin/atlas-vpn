...
const faq = [
  ...
  },
  {
    ...
    a: "Одна подписка — одно устройство. Так дешевле для всех: никто не делит скорость с чужими устройствами. Нужен VPN и на телефоне, и на ноутбуке — оформите вторую подписку на другой email.",
  },
  {
