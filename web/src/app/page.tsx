...
const faq = [
  {
    ...
    a: "Доступ прекратится. Деньги не спишутся: карта не нужна. Чтобы продолжить, напишите нам — ссылка и настройки останутся прежними.",
  },
  {
  ...
  },
  {
    ...
    a: "Для чего-либо незаконного, рассылки спама, атак на чужие системы и любых действий, которые вредят другим людям или сервису.",
  },
  {
