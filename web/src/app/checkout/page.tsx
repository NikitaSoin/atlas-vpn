  ...
  return (
    <main className="mx-auto max-w-md px-5 py-16">
      ...
      <div className="mt-6 rounded-2xl border border-line bg-surface p-6">
        ...
        {/*
          Предупреждение стоит НАД кнопкой и выделено намеренно. Подтверждение
          карты по 3-D Secure открывается на странице банка, а банковские
          страницы недоступны с зарубежных адресов: платёж зависает на шаге
          подтверждения и человек видит «не удаётся установить соединение».
          Проверено 11.09.2026: secure.tbank.ru не открывается через
          зарубежный выход и открывается напрямую. Для нас это особенно
          болезненно: продлевать подписку человек идёт как раз из-под VPN.
        */}
        {acquiringConfigured() && (
          <div className="mt-4 rounded-2xl border border-amber-500/50 bg-amber-500/10 p-4 text-sm">
            <p className="font-medium text-amber-700">Перед оплатой выключите VPN</p>
            <p className="mt-1 leading-relaxed text-fg/80">
              Банк подтверждает карту на своей странице, а она открывается только
              с российского адреса. Если VPN включён, оплата зависнет на подтверждении.
              Выключите его на минуту, оплатите и включайте обратно — доступ никуда
              не денется.
            </p>
          </div>
        )}
        ...
        <p className="mt-4 text-center text-xs leading-relaxed text-muted">
          {acquiringConfigured()
            ? "После нажатия откроется защищённая страница оплаты ЮKassa. Заплатить можно картой, через СБП или ЮMoney. Данные карты остаются у платёжного сервиса, мы их не видим и не храним."
