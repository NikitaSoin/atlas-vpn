    ...
    >
      ...
      {!emailLocked && (
        <p className="text-sm text-muted">
          Можно оплатить без предварительной регистрации. Ссылка для настройки
          придёт на почту.
        </p>
      )}
      {/* Автопродление выключено осознанно: регулярные списания на стороне
          банка ещё не подключены, а обещать неработающую функцию нельзя.
          Галочка остаётся видимой и заблокированной, чтобы ожидание было
          честным: оплата — разовая. */}
